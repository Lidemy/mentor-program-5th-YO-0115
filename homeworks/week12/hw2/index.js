...
$(document).ready(() => {
  ...
  $('.list__save').on('click', () => {
    ...
    $.ajax({
      type: 'POST',
      url: 'http://mentor-program.co/mtr04group3/YO/week12/hw2/api_add_todo.php',
      data: {
        token: getToken(),
        todo: data
      },
  ...
  $('.list__token').on('click', () => {
    ...
    if (input) {
      ...
      $.getJSON(`http://mentor-program.co/mtr04group3/YO/week12/hw2/api_get_todo.php?token=${input}`, (data) => {
